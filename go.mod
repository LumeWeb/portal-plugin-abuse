...
require (
	...
	go.lumeweb.com/portal v0.4.2-0.20250401205133-a74e58626408
	go.lumeweb.com/portal-testutil v0.2.25
	go.lumeweb.com/queryutil v0.2.1
...
replace (
	...
	gorm.io/plugin/dbresolverv1.3.0 => gorm.io/plugin/dbresolver v1.5.3
)
